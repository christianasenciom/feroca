  ...
  <el-form ref="sendMailsFormRef" :model="form_send_mail" label-position="top" label-width="120px" v-loading="loadingSaveDialogForm" v-on:submit.prevent>
    <el-row type="flex" justify="center" :gutter="20">
      ...
      <el-form-item label="Región" prop="region">
            <el-input v-model="form_send_mail.region" placeholder="Región" disabled/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        <el-form-item label="Provincia" prop="provincia" style="width: 100%" >
          <el-input v-model="form_send_mail.provincia" placeholder="Provincia" type="text" disabled />
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item label="Distrito" prop="distrito" style="width: 100%" >
          <el-input v-model="form_send_mail.distrito" placeholder="Distrito" type="text" disabled />
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item label="Sector" prop="sector" style="width: 100%" >
          <el-input v-model="form_send_mail.sector" placeholder="Sector" type="text" disabled />
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item label="Base" prop="base" style="width: 100%" >
          <el-input v-model="form_send_mail.base" placeholder="Base" type="text" disabled />
        </el-form-item>
      </el-col>
      <el-col :span="24">
...
const fetchTurno = async () => {
  ...
  await turnoResource.get(props.idTurno)
      .then(response => {
        ...
        form_send_mail.region = data.region.descripcion;
        form_send_mail.provincia = data.provincia.descripcion;
        form_send_mail.distrito = data.distrito.descripcion;
        form_send_mail.sector = data.sector.descripcion;
        form_send_mail.base = data.base.descripcion;
