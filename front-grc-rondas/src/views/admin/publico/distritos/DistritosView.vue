      ...
      <div>
        <el-form ref="formCreateEditDistrito" v-loading="loadingSaveDialogForm" :model="modelDistrito"
          ...
          <el-form-item label="Provincia" prop="provincia_id">
            <el-select ref="provincia_idField" v-model="modelDistrito.provincia_id" placeholder="Provincia" style="width: 100%" filterable>
              <el-option
...
export default {
  ...
  setup() {
    ...
    const openFormCreate = () => {
      ...
      nextTick(() => {
        fetchProvincias(); //cargar provincias
    ...
    const openFormEditar = async (id) => {
      await fetchProvincias(); //cargar provincias
    ...
    const fetchProvincias = async () => {
      try {
        // Crear un query específico para provincias sin paginación
        ...
        await provinciaResource.list(queryProvincias)
          .then(response => {
            const { data } = response;
        ...
        console.error('Error en fetchProvincias:', error);
      }
    };
